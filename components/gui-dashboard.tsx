...
import { Code, Brain, Zap, Disc, Layers, Sparkles } from "lucide-react"
        ...
        <div className="relative w-full h-full max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-2 md:p-4">
            ...
            <motion.div
              ...
              className="col-span-1 md:col-span-2 bg-slate-800/60 backdrop-blur-md rounded-lg border border-slate-700/50 p-3 md:p-4 flex flex-col sm:flex-row items-center justify-between gap-3"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="font-vt323 text-2xl md:text-3xl text-white">Just Press Tab</h1>
                </div>
              </div>
              <div className="font-mono text-base text-slate-400 text-center sm:text-right">
                <span className="text-cyan-400">kyle.hammitt</span>@<span className="text-red-400">just-press-tab.com</span>
              </div>
            </motion.div>
            ...
            <DashboardTile
              ...
              onHover={() => setHoverTile("resume")}
              onLeave={() => setHoverTile(null)}
              isHovered={hoverTile === "resume"}
  ...
  return (
    ...
    >
      <div className="p-3 md:p-4 h-full flex flex-col">
        ...
        <h3 className="font-vt323 text-lg md:text-xl text-white mb-2">{title}</h3>
                                <p className="font-mono text-base text-slate-400 mb-3 line-clamp-2">{description}</p>

        <div className="mt-auto flex items-center justify-between">
          <div className="w-16 h-16 md:w-20 md:h-20">
            <div className="w-full h-full rounded-md bg-slate-900/50 flex items-center justify-center text-slate-700">
              <img src={imagePlaceholder || "/placeholder.svg"} alt={imageAlt} className="w-full h-full object-cover rounded-md" />
            </div>
          </div>
